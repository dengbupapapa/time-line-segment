...
var Segment = function (_EventDispatcher) {
    ...
    _createClass(Segment, [{
        ...
        value: function transactions() {
            ...
            var transactionsArguments = (_ref17 = []).concat.apply(_ref17, arguments).map(function () {
                for (var _len12 = arguments.length, item = Array(_len12), _key12 = 0; _key12 < _len12; _key12++) {
                    item[_key12] = arguments[_key12];
                }
...
function updatePlaceholderTransactionDuration() {
    ...
    this._transactions[0].tween._onUpdate(function (_ref18) {
...
function segmentRun() {
    ...
    //开始
    var startElements = transactions.map(function (_ref23) {
        var tween = _ref23.tween,
            fn = _ref23.fn,
            type = _ref23.type;

        return new _Promise(function (resolve) {
            tween._onStart(function (_ref24) {
                var time = _ref24.time;
    ...
    //完整的结束之前
    var beforeFinishElements = transactions.map(function (_ref25) {
...
function finishAfterStatusExecFn() {
    ...
    if (this._finishAfterStatus === "start") {
        ...
        transactionsSort.forEach(function (_ref29) {
            var fn = _ref29.fn,
                value = _ref29.value,
                type = _ref29.type,
        ...
        _transactionsSort.forEach(function (_ref30) {
            var fn = _ref30.fn,
                value = _ref30.value,
                finishAfterStatusExec = _ref30.finishAfterStatusExec;
