...
var Segment = function (_EventDispatcher) {
    ...
    _createClass(Segment, [{
        ...
        value: function dispose() {
            ...
            var transactions = this._transactions.filter(function (_ref17) {
                var tween = _ref17.tween;
                return tween._isPlaying;
            });
...
function updatePlaceholderTransactionDuration() {
    ...
    this._transactions[0].tween._onUpdate(function (_ref18) {
        ...
        _this9._transactions[0].fn(time, percent, globalPercent, _this9._totalTime);
    });
}
...
function createTween(_ref19) {
    ...
    if (type === "interval") {
        ...
        tween._onUpdate(function (_ref20) {
            ...
            fn(time, percent, globalPercent, _this10._totalTime);
        });
...
function segmentRun() {
    ...
    var startElements = transactions.map(function (_ref23) {
        ...
        return new _Promise(function (resolve) {
            tween._onStart(function (_ref24) {
                ...
                fn(time, elapsed, time / _this11._totalTime, _this11._totalTime);
                resolve();
            });
        });
    });
    ...
    _Promise.race(startElements).then(function () {
        _this11.dispatchEvent({ type: START, transactions: transactions });
    });
    ...
    _Promise.all(beforeFinishElements).then(function () {
        // this._isPlaying = false;
        _this11.dispatchEvent({ type: BEFORE_FINISH, transactions: transactions });
        //如果有定义下一个衔接的片段
    ...
    _Promise.all(finishElements).then(function () {
        finishAfterStatusExecFn.call(_this11);
        ...
        if (typeof _this11._nextSegmentStrat === "function" && result.includes("complete")) {
            ...
            if (_this11._nextSegment instanceof Segment && _this11._nextSegment.hasEventListener(START, _this11._currentSegmentFinish2nextSegmentStartCallback)) {
                _this11._nextSegment.removeEventListener(START, _this11._currentSegmentFinish2nextSegmentStartCallback);
            }
            _this11._currentSegmentFinish2nextSegmentStartCallback = function () {
                if (_this11._nextSegment instanceof Segment) {
                    _this11._nextSegment.removeEventListener(START, _this11._currentSegmentFinish2nextSegmentStartCallback);
                }
                _this11._currentSegmentFinish2nextSegmentStartCallback = null;
                _this11.dispatchEvent({ type: FINISH, transactions: transactions });
            };
            if (_this11._nextSegment instanceof Segment) {
                _this11._nextSegment.addEventListener(START, _this11._currentSegmentFinish2nextSegmentStartCallback);
