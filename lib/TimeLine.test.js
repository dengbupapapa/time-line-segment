(function (global, factory) {
            ...
            var Segment = function (_EventDispatcher) {
                ...
                function Segment() {
                    ...
                    _this.addEventListener(FINISH, function () {
                        var totalTime = _this.getTotalTime();
                        if (_this._finishAfterStatus === "start") {
                            var transactionsSort = [].concat(_toConsumableArray(_this._transactions)).sort(function (transactionA, transactionB) {
                            ...
                            transactionsSort.forEach(function (_ref) {
                                var fn = _ref.fn,
                                    value = _ref.value,
                                    type = _ref.type,
                                    finishAfterStatusExec = _ref.finishAfterStatusExec;
                        ...
                        } else if (_this._finishAfterStatus === "end") {
                            var _transactionsSort = [].concat(_toConsumableArray(_this._transactions)).sort(function (transactionA, transactionB) {
                                var valueA = transactionA.value;
                                var valueB = transactionB.value;
                            ...
                            _transactionsSort.forEach(function (_ref2) {
                                var fn = _ref2.fn,
                                    value = _ref2.value,
                                    finishAfterStatusExec = _ref2.finishAfterStatusExec;
            ...
            function updatePlaceholderTransactionDuration() {
                ...
                this._transactions[0].tween._onUpdate(function (_ref19) {
            ...
            function createTween(_ref20) {
                var _this8 = this;

                var type = _ref20.type,
                    value = _ref20.value,
                    fn = _ref20.fn,
                    easing = _ref20.easing;
                ...
                if (type === "interval") {
                    ...
                    tween._onUpdate(function (_ref21) {
            ...
            function segmentRun() {
                ...
                //完整的结束之前
                var beforeFinishElements = transactions.map(function (_ref26) {
                ...
                //完整的结束
                var completeElements = transactions.map(function (_ref27) {
                ...
                _Promise.all(finishElements).then(function () {
                    var result = transactions.map(function (_ref28) {
                        var finishType = _ref28.finishType;
                        return finishType;
                    });
                ...
                transactions.forEach(function (_ref29) {
                    var tween = _ref29.tween,
                        type = _ref29.type,
                        value = _ref29.value;
