(function (global, factory) {
            ...
            var Segment = function (_EventDispatcher) {
                ...
                _createClass(Segment, [{
                    ...
                    value: function transactions() {
                        ...
                        var transactionsArguments = arg.map(function (item) {
                            return formatTransactionArguments.apply(_this7, item);
                        });
                        this._transactions = [this._transactions[0]].concat(_toConsumableArray(transactionsArguments));
                    }
                }, {
                    key: "getTotalTime",
            ...
            function updatePlaceholderTransactionDuration() {
                ...
                this._transactions[0].tween._onUpdate(function (_ref17) {
                    ...
                    typeof _this8._transactions[0].fn === "function" && _this8._transactions[0].fn(time, percent, globalPercent, _this8._totalTime);
                });
            }
            ...
            function createTween(_ref18) {
                ...
                if (type === "interval") {
                    ...
                    tween._onUpdate(function (_ref19) {
                        ...
                        var globalPercent = time / _this9._totalTime;
                        typeof fn === "function" && fn(time, percent, globalPercent, _this9._totalTime);
                    });
            ...
            function segmentRun() {
                ...
                var startElements = transactions.map(function (_ref22) {
                    ...
                    return new _Promise(function (resolve) {
                        tween._onStart(function (_ref23) {
                            ...
                            fn(time, elapsed, time / _this10._totalTime, _this10._totalTime);
                            resolve();
                        });
                    });
                });
                ...
                _Promise.race(startElements).then(function () {
                    _this10.dispatchEvent({ type: START, transactions: transactions });
                });
                ...
                _Promise.all(beforeFinishElements).then(function () {
                    // this._isPlaying = false;
                    _this10.dispatchEvent({ type: BEFORE_FINISH, transactions: transactions });
                    //如果有定义下一个衔接的片段
                ...
                _Promise.all(completeElements).then(function () {
                    // this._isPlaying = false;
                    _this10.dispatchEvent({ type: COMPLETE, transactions: transactions });
                    //如果有定义下一个衔接的片段
                    // if (this._nextSegment instanceof Segment) this._nextSegment.start();
                });
                ...
                _Promise.all(finishElements).then(function () {
                    finishAfterStatusExecFn.call(_this10);
                    var result = transactions.map(function (_ref26) {
                        var finishType = _ref26.finishType;
                        return finishType;
                    });
                    //如果有定义下一个衔接的片段，并且没有全部停止，接衔接
                    if (typeof _this10._nextSegmentStrat === "function" && result.includes("complete")) {
                        //先开始在结束，防止_currentSegment有间隙无法正常操作
                        if (_this10._nextSegment instanceof Segment && _this10._nextSegment.hasEventListener(START, _this10._currentSegmentFinish2nextSegmentStartCallback)) {
                            _this10._nextSegment.removeEventListener(START, _this10._currentSegmentFinish2nextSegmentStartCallback);
                        }
                        _this10._currentSegmentFinish2nextSegmentStartCallback = function () {
                            if (_this10._nextSegment instanceof Segment) {
                                _this10._nextSegment.removeEventListener(START, _this10._currentSegmentFinish2nextSegmentStartCallback);
                            }
                            _this10._currentSegmentFinish2nextSegmentStartCallback = null;
                            _this10.dispatchEvent({ type: FINISH, transactions: transactions });
                        };
                        if (_this10._nextSegment instanceof Segment) {
                            _this10._nextSegment.addEventListener(START, _this10._currentSegmentFinish2nextSegmentStartCallback);
                            _this10._nextSegmentStrat();
                        }
                    } else {
                        _this10.dispatchEvent({ type: FINISH, transactions: transactions });
                    }
                ...
                transactions.forEach(function (_ref27) {
                    ...
                    if (!playback) {
                        ...
                        if (type === "interval") {
                            tween.delay(_this10._totalTime - value[1]);
                        } else if (type === "point") {
                            tween.delay(_this10._totalTime - value);
                        }
                    }
                    ...
                    value: function start(customSegment) {
                        ...
                        this._endSegmentFinishCallback = function (_ref2) {
                            ...
                            if (typeof _this4._nextArrangeStrat === "function" && result.includes("complete")) {
                                if (_this4._nextArrange instanceof Arrange && _this4._nextArrange.hasEventListener(START, _this4._currentArrangeFinish2nextArrangeStartCallback)) {
                                ...
                                _this4._currentArrangeFinish2nextArrangeStartCallback = function () {
                                    if (_this4._nextArrange instanceof Arrange) {
                                        _this4._nextArrange.removeEventListener(START, _this4._currentArrangeFinish2nextArrangeStartCallback);
                                    }
