(function (global, factory) {
            ...
            function updatePlaceholderTransactionDuration() {
                ...
                this._transactions[0].tween._onUpdate(function (_ref17) {
                    ...
                    _this8._transactions[0].fn(time, percent, globalPercent, _this8._totalTime);
                });
            }
            ...
            function createTween(_ref18) {
                ...
                if (type === "interval") {
                    ...
                    tween._onUpdate(function (_ref19) {
                        ...
                        fn(time, percent, globalPercent, _this9._totalTime);
                    });
            ...
            function segmentRun() {
                ...
                _Promise.all(finishElements).then(function () {
                    ...
                    if (typeof _this10._nextSegmentStrat === "function" && result.includes("complete")) {
                        ...
                        if (_this10._nextSegment.hasEventListener(START, _this10._currentSegmentFinish2nextSegmentStartCallback)) {
