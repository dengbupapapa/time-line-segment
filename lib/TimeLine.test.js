                    ...
                    value: function dispose() {
                        ...
                        if (!this._disposeFinishCallback) {
                            ...
                            this._disposeFinishCallback = function () {
                                var currentArrangelength = _this11._currentArrange.length;
                                for (var i = 0; i < currentArrangelength; i++) {
                                    _this11._currentArrange[i].dispose();
                                }
                                var segmentslength = _this11._segments.length;
                                for (var _i = 0; _i < segmentslength; _i++) {
                                    _this11._segments[_i].dispose();
                                }
                                _this11._currentArrange = [];
                                _this11._segments = [];
