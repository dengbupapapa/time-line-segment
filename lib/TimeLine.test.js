(function (global, factory) {
            ...
            $export$1($export$1.S + $export$1.F * !require$$7(function (iter) { Array.from(iter); }), 'Array', {
            ...
            var require$$0$f = ( from$1 && from ) || from$1;
            ...
            var require$$0$g = ( getPrototypeOf$1 && getPrototypeOf ) || getPrototypeOf$1;
            ...
            var require$$0$h = ( defineProperty$2 && defineProperty$1 ) || defineProperty$2;
            ...
            var require$$0$i = ( _objectAssign$1 && _objectAssign ) || _objectAssign$1;

            // 19.1.3.1 Object.assign(target, source)


            $export$1($export$1.S + $export$1.F, 'Object', { assign: require$$0$i });
            ...
            var require$$0$j = ( assign$1 && assign ) || assign$1;
            ...
            _Object$assign(EventDispatcher.prototype, {
                ...
                disposeEvent: function disposeEvent() {
            ...
            var RESUME = "resume";
            var UPDATE = "update";
            var BEFORE_FINISH = "beforeFinish";
            ...
            var require$$0$l = ( promise$1 && promise ) || promise$1;
            ...
            var Segment = function (_EventDispatcher) {
                ...
                function Segment() {
                    ...
                    var placeholderTransactionFn = function placeholderTransactionFn(time, elapsed, globalPercent, totalTime) {
                        //为了防止超标，且保留结束前的事件
                        globalPercent = globalPercent > 1 ? 1 : globalPercent;
                        time = time > _this._totalTime ? _this._totalTime : time;
                        _this.dispatchEvent({
                            type: UPDATE,
                            time: time,
                            elapsed: elapsed,
                ...
                _createClass(Segment, [{
                    key: "setFinishAfterStatus",
                    value: function setFinishAfterStatus() {
                        var status = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "default";
                    ...
                    value: function transaction() {
                        ...
                        var transactionArguments = formatTransactionArguments.apply(this, arg);
                        this._transactions.push(transactionArguments);
                        return this;
                    }
                }, {
                    key: "removeTransaction",
                    value: function removeTransaction() {
                        var _this5 = this;
                        ...
                        this._transactions = this._transactions.filter(function (_ref15) {
                            var name = _ref15.name,
                                id = _ref15.id;
                            return !names.includes(name) && !names.includes(id) || name === placeholderTransaction;
                        });
                        ...
                        this._transactions.forEach(function (_ref16) {
                            ...
                            updatePlaceholderTransactionDuration.call(_this5);
                        });
                    }
                }, {
                    key: "editTransaction",
                    value: function editTransaction(identify) {
                        var _this6 = this;

                        for (var _len11 = arguments.length, arg = Array(_len11 > 1 ? _len11 - 1 : 0), _key11 = 1; _key11 < _len11; _key11++) {
                            arg[_key11 - 1] = arguments[_key11];
                        }

                        this._transactions.forEach(function (transaction, i) {
                            var name = transaction.name,
                                id = transaction.id;

                            if (identify === name || identify === id) {
                                _this6._transactions[i] = formatTransactionArguments.apply(_this6, arg);
                            }
                        });
                    }
                }, {
            ...
            function updatePlaceholderTransactionDuration() {
                ...
                var endTime = this._totalTime + minDuration;
                this._transactions[0].tween.to({
                    time: endTime
                }, endTime);
                this._transactions[0].value = [0, endTime];

                this._transactions[0].tween._onUpdate(function (_ref17) {
                    var time = _ref17.time;

                    var percent = time / endTime;
                    var globalPercent = time / endTime;
                    _this7._transactions[0].fn(time, percent, globalPercent, _this7._totalTime);
                });
            }

            function formatTransactionArguments() {
                ...
                var _options = options,
                    ...
                    _options$finishAfterS = _options.finishAfterStatusExec,
                    finishAfterStatusExec = _options$finishAfterS === undefined ? true : _options$finishAfterS;
                ...
                if (typeof id !== "undefined" && typeof id !== "string" && typeof id !== "number") {
                ...
                if (arg.length === 1) {
                    ...
                    return {
                        ...
                        type: "point",
                        value: arg[0],
                        finishAfterStatusExec: finishAfterStatusExec
                    };
            ...
            function createTween(_ref18) {
                var _this8 = this;

                var type = _ref18.type,
                    value = _ref18.value,
                    fn = _ref18.fn,
                    easing = _ref18.easing;
                ...
                if (type === "interval") {
                    ...
                    tween._onUpdate(function (_ref19) {
                        var time = _ref19.time;

                        var percent = (time - value[0]) / (value[1] - value[0]);
                        var globalPercent = time / _this8._totalTime;
                        fn(time, percent, globalPercent, _this8._totalTime);
                    });
            ...
            function segmentRun() {
                ...
                var startElements = transactions.map(function (_ref22) {
                    ...
                    return new _Promise(function (resolve) {
                        tween._onStart(function (_ref23) {
                            ...
                            var elapsed = type === "interval" ? 0 : 1;
                            fn(time, elapsed, time / _this9._totalTime, _this9._totalTime);
                            resolve();
                        });
                    });
                });
                ...
                _Promise.race(startElements).then(function () {
                    _this9.dispatchEvent({ type: START, transactions: transactions });
                });

                //完整的结束之前
                var beforeFinishElements = transactions.map(function (_ref24) {
                    var tween = _ref24.tween,
                        type = _ref24.type,
                        value = _ref24.value;

                    return new _Promise(function (resolve) {
                        tween._onBeforeFinish(function () {
                            resolve();
                        });
                    });
                });

                _Promise.all(beforeFinishElements).then(function () {
                    // this._isPlaying = false;
                    _this9.dispatchEvent({ type: BEFORE_FINISH, transactions: transactions });
                    //如果有定义下一个衔接的片段
                    // if (this._nextSegment instanceof Segment) this._nextSegment.start();
                });

                //完整的结束
                var completeElements = transactions.map(function (_ref25) {
                    var tween = _ref25.tween,
                        type = _ref25.type,
                        value = _ref25.value;
                ...
                _Promise.all(completeElements).then(function () {
                    // this._isPlaying = false;
                    _this9.dispatchEvent({ type: COMPLETE, transactions: transactions });
                    //如果有定义下一个衔接的片段
                    // if (this._nextSegment instanceof Segment) this._nextSegment.start();
                });
                ...
                _Promise.all(finishElements).then(function () {
                    finishAfterStatusExecFn.call(_this9);
                    var result = transactions.map(function (_ref26) {
                        var finishType = _ref26.finishType;
                        return finishType;
                    });
                    //如果有定义下一个衔接的片段，并且没有全部停止，接衔接
                    if (typeof _this9._nextSegmentStrat === "function" && result.includes("complete")) {
                        //先开始在结束，防止_currentSegment有间隙无法正常操作
                        if (_this9._nextSegment.hasEventListener(START, _this9._currentSegmentFinish2nextSegmentStartCallback)) {
                            _this9._nextSegment.removeEventListener(START, _this9._currentSegmentFinish2nextSegmentStartCallback);
                        }
                        _this9._currentSegmentFinish2nextSegmentStartCallback = function () {
                            _this9._nextSegment.removeEventListener(START, _this9._currentSegmentFinish2nextSegmentStartCallback);
                            _this9._currentSegmentFinish2nextSegmentStartCallback = null;
                            _this9.dispatchEvent({ type: FINISH, transactions: transactions });
                        };
                        _this9._nextSegment.addEventListener(START, _this9._currentSegmentFinish2nextSegmentStartCallback);
                        _this9._nextSegmentStrat();
                    } else {
                        _this9.dispatchEvent({ type: FINISH, transactions: transactions });
                    }
                });

                transactions.forEach(function (_ref27) {
                    var tween = _ref27.tween,
                        type = _ref27.type,
                        value = _ref27.value;
                    ...
                    if (!playback) {
                        ...
                        if (type === "interval") {
                            tween.delay(_this9._totalTime - value[1]);
                        } else if (type === "point") {
                            tween.delay(_this9._totalTime - value);
                        }
                    }
            ...
            function finishAfterStatusExecFn() {
                ...
                if (this._finishAfterStatus === "start") {
                    var transactionsSort = [].concat(_toConsumableArray(this._transactions)).sort(function (transactionA, transactionB) {
                        var valueA = transactionA.value;
                        var valueB = transactionB.value;
                        var timeA = valueA instanceof Array ? valueA[0] : valueA;
                        var timeB = valueB instanceof Array ? valueB[0] : valueB;
                        return timeB - timeA;
                    });
                    transactionsSort.forEach(function (_ref28) {
                        var fn = _ref28.fn,
                            value = _ref28.value,
                            type = _ref28.type,
                            finishAfterStatusExec = _ref28.finishAfterStatusExec;

                        if (!finishAfterStatusExec) return;
                        var time = value instanceof Array ? value[0] : value;
                        var elapsed = type === "interval" ? 0 : 1;
                        var globalPercent = time / totalTime;
                        fn(time, elapsed, globalPercent, totalTime);
                    });
                } else if (this._finishAfterStatus === "end") {
                    var _transactionsSort = [].concat(_toConsumableArray(this._transactions)).sort(function (transactionA, transactionB) {
                        var valueA = transactionA.value;
                        var valueB = transactionB.value;
                        var timeA = valueA instanceof Array ? valueA[1] : valueA;
                        var timeB = valueB instanceof Array ? valueB[1] : valueB;
                        return timeA - timeB;
                    });
                    _transactionsSort.forEach(function (_ref29) {
                        var fn = _ref29.fn,
                            value = _ref29.value,
                            finishAfterStatusExec = _ref29.finishAfterStatusExec;

                        if (!finishAfterStatusExec) return;
                        var time = value instanceof Array ? value[1] : value;
                        var globalPercent = time / totalTime;
            ...
            var Arrange = function (_EventDispatcher) {
                ...
                function Arrange(segments) {
                    ...
                    _this._currentSegmentStartCallback = function (_ref) {
                        var target = _ref.target;

                        //如果排序处于停止状态则取消监听
                        if (!_this._isPlaying) return;
                        _this._currentSegment = target;
                        _this.dispatchEvent({ type: UPDATE, currentSegment: target });
                    };
                    ...
                    for (var i = 0; i < length; i++) {
                        ...
                        currentSegment.addEventListener(START, _this._currentSegmentStartCallback);
                ...
                _createClass(Arrange, [{
                    ...
                    value: function setSegments() {
                        ...
                        segments.forEach(function (segment) {
                            ...
                            segment.addEventListener(START, _this2._currentSegmentStartCallback);
                        });
                    ...
                    value: function addSegments() {
                        ...
                        for (var _len2 = arguments.length, segments = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
                        ...
                        segments.forEach(function (segment) {
                            ...
                            segment.addEventListener(START, _this3._currentSegmentStartCallback);
                        });
                    ...
                    value: function start(customSegment) {
                        ...
                        //结束事件回调
                        this._endSegmentFinishCallback = function (_ref2) {
                            ...
                            var result = transactions.map(function (_ref3) {
                                var finishType = _ref3.finishType;
                                return finishType;
                            });
                            //如果有定义下一个衔接的片段，并且没有全部停止，接衔接
                            if (typeof _this4._nextArrangeStrat === "function" && result.includes("complete")) {
                                if (_this4._nextArrange.hasEventListener(START, _this4._currentArrangeFinish2nextArrangeStartCallback)) {
                                    _this4._nextArrange.removeEventListener(START, _this4._currentArrangeFinish2nextArrangeStartCallback);
                                }
                                _this4._currentArrangeFinish2nextArrangeStartCallback = function () {
                                    _this4._nextArrange.removeEventListener(START, _this4._currentArrangeFinish2nextArrangeStartCallback);
                                    _this4._currentArrangeFinish2nextArrangeStartCallback = null;
                                    _this4.dispatchEvent({
                                        type: FINISH
                                    });
                                };
                                _this4._nextArrange.addEventListener(START, _this4._currentArrangeFinish2nextArrangeStartCallback);
                        ...
                        this._startSegmentCompleteCallback = function () {
                            _this4._startSegment.removeEventListener(START, _this4._startSegmentCompleteCallback);
                            _this4._startSegmentCompleteCallback = undefined;
                            _this4.dispatchEvent({
                                type: START
                            });
                        };
                        ...
                        if (this._currentSegment instanceof Segment) {
                            if (this._currentSegment !== this._endSegment) {
                                ...
                                this._currentSegmentFinishForStopCallback = function () {
                                    _this5._isPlaying = false;
                                    _this5._currentSegment.removeEventListener(FINISH, _this5._currentSegmentFinishForStopCallback);
                                    _this5._currentSegmentFinishForStopCallback = undefined;
                    ...
                    value: function pause() {
                        ...
                        if (this._currentSegment instanceof Segment) {
                            ...
                            this._currentSegmentPauseCallback = function () {
                                _this6._isPaused = true;
                                _this6._currentSegment.removeEventListener(PAUSE, _this6._currentSegmentPauseCallback);
                                _this6._currentSegmentPauseCallback = undefined;
                    ...
                    value: function resume() {
                        ...
                        if (this._currentSegment instanceof Segment) {
                            ...
                            this._currentSegmentResumeCallback = function () {
                                ...
                                _this7._currentSegment.removeEventListener(RESUME, _this7._currentSegmentResumeCallback);
                                _this7._currentSegmentResumeCallback = undefined;
                    ...
                    value: function execute(segment) {
                        ...
                        this._executeForPrevFinishCallback = function () {
                            ...
                            if (isPaused) {
                                if (segment.hasEventListener(FINISH, _this8._executeForTargetSegmentFinishCallback)) {
                                    segment.removeEventListener(FINISH, _this8._executeForTargetSegmentFinishCallback);
                                }
                                _this8._executeForTargetSegmentFinishCallback = function () {
                                    _this8.pause();
                                    _this8._executeing = false;
                                    segment.removeEventListener(FINISH, _this8._executeForTargetSegmentFinishCallback);
                                    _this8._executeForTargetSegmentFinishCallback = undefined;
                                };
                                segment.addEventListener(FINISH, _this8._executeForTargetSegmentFinishCallback);
                            } else {
                                _this8._executeing = false;
                            }

                            _this8.start(segment);

                            _this8.removeEventListener(FINISH, _this8._executeForPrevFinishCallback);
                            _this8._executeForPrevFinishCallback = undefined;
                        };
                    ...
                    value: function _switch(segment) {
                        ...
                        this._switchForPrevFinishCallback = function () {
                            ...
                            if (isPaused) {
                                if (_this9.hasEventListener(START, _this9._switchForStartAfterCallback)) {
                                    _this9.removeEventListener(START, _this9._switchForStartAfterCallback);
                                }
                                _this9._switchForStartAfterCallback = function () {
                                    _this9.pause();
                                    _this9._switching = false;
                                    _this9.removeEventListener(START, _this9._switchForStartAfterCallback);
                                    _this9._switchForStartAfterCallback = undefined;
                                };
                                _this9.addEventListener(START, _this9._switchForStartAfterCallback);
                            } else {
                                _this9._switching = false;
                            }
                            _this9.start(segment);
                            _this9.removeEventListener(FINISH, _this9._switchForPrevFinishCallback);
                            _this9._switchForPrevFinishCallback = undefined;
                        };
            ...
            var arrangeMode = {
                ...
                forward: function forward(customSegment) {
                    ...
                    for (var i = 0; i < length; i++) {
                        ...
                        if (currentSegment instanceof Segment && nextSegment instanceof Segment) {
            ...
            var TimeLine = function (_EventDispatcher) {
                ...
                function TimeLine() {
                    ...
                    _this._arrangements = [];
                    _this._forceStartForStartCallback = function () {
                        _this._forceStarting = false;
                    };
                    return _this;
                }
                ...
                _createClass(TimeLine, [{
                    key: "getSegmentById",
                    value: function getSegmentById(id) {
                        return this._segments.find(function (segment) {
                    ...
                    value: function setSegments() {
                        ...
                        this._segments = segments;
                        this._arrangements.forEach(function (arrangement) {
                            arrangement.setSegments.apply(arrangement, _toConsumableArray(_this2._segments));
                        });
                    ...
                    value: function addSegments() {
                        ...
                        (_segments = this._segments).push.apply(_segments, segments);
                        this._arrangements.forEach(function (arrangement) {
                            arrangement.setSegments.apply(arrangement, _toConsumableArray(_this3._segments));
                        });
                        // this.clearArrangements();
                    }
                }, {
                    ...
                    value: function start() {
                        ...
                        if (length === 0) {
                            ...
                            this._defaultArrangeForPrevFinishCallback = function () {
                                defaultArrange.removeEventListener(FINISH, _this4._defaultArrangeForPrevFinishCallback);
                                _this4._defaultArrangeForPrevFinishCallback = undefined;
                                _this4.clearArrangements();
                            };
                        ...
                        this._endArrangeEventListenerFn = function () {
                            ...
                            repeat++;
                            //如果完成规定次数则停止
                            if (repeat >= _this4._repeat || _this4._needStop) {
                                _this4._isPlaying = false;
                                //并且移除该事件
                                _this4._endArrange.removeEventListener(FINISH, _this4._endArrangeEventListenerFn);
                                _this4._endArrangeEventListenerFn = undefined;
                                //如果是自然结束
                                if (repeat >= _this4._repeat && !_this4._needStop) {
                                    _this4.dispatchEvent({
                                        type: COMPLETE
                                ...
                                //如果结束，当前排序是最后排序则触发事件
                                if (_this4._currentArrange === _this4._endArrange) {
                                    _this4._needStop = false;
                                    _this4.dispatchEvent({
                                        type: FINISH
                                    });
                                }
                        ...
                        this._startArrangeCompleteCallback = function () {
                            _this4._startArrange.removeEventListener(START, _this4._startArrangeCompleteCallback);
                            _this4._startArrangeCompleteCallback = undefined;
                            _this4.dispatchEvent({
                                type: START
                            });
                        };
                    ...
                    value: function forceStart() {
                        ...
                        for (var _len3 = arguments.length, target = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
                            target[_key3] = arguments[_key3];
                        }
                        ...
                        //如果是运行状态，那么需要先停止再开始。
                        if (this._isPlaying) {
                            if (this.hasEventListener(FINISH, this._finishForForceStartCallback)) {
                                this.removeEventListener(FINISH, this._finishForForceStartCallback);
                            }
                            this._finishForForceStartCallback = function () {
                                _this5.removeEventListener(FINISH, _this5._finishForForceStartCallback);
                                _this5._finishForForceStartCallback = undefined;
                                _this5.onceEventListener(START, _this5._forceStartForStartCallback);
                                _this5.start.apply(_this5, target);
                            };
                        ...
                        if (this._currentArrange instanceof Arrange) {
                            ...
                            if (currentArrange !== endArrange) {
                                ...
                                this._currentArrangeFinishForStopCallback = function () {
                                    _this6._currentArrange.removeEventListener(FINISH, _this6._currentArrangeFinishForStopCallback);
                                    _this6._currentArrangeFinishForStopCallback = undefined;
                                    _this6.dispatchEvent({
                                        type: FINISH
                                    });
                                };
                    ...
                    value: function pause() {
                        ...
                        if (this._currentArrange instanceof Arrange) {
                            ...
                            this._currentArrangePauseCallback = function () {
                                _this7._isPaused = true;
                                _this7._currentArrange.removeEventListener(PAUSE, _this7._currentArrangePauseCallback);
                                _this7._currentArrangePauseCallback = undefined;
                                _this7.dispatchEvent({
                                    type: PAUSE
                                });
                            };
                    ...
                    value: function resume() {
                        ...
                        if (this._currentArrange instanceof Arrange) {
                            ...
                            this._currentArrangeResumeCallback = function () {
                                _this8._isPaused = false;
                                _this8._currentArrange.removeEventListener(RESUME, _this8._currentArrangeResumeCallback);
                                _this8._currentArrangeResumeCallback = undefined;
                    ...
                    value: function execute() {
                        ...
                        this._executeForPrevFinishCallback = function () {
                            //如果是暂停的就切换到对应segment后执行完就暂停
                            if (isPaused) {
                                if (segment.hasEventListener(BEFORE_FINISH, _this9._executeForTargetSegmentBeforreFinishCallback)) {
                                    segment.removeEventListener(BEFORE_FINISH, _this9._executeForTargetSegmentBeforreFinishCallback);
                                }
                                _this9._executeForTargetSegmentBeforreFinishCallback = function () {
                                    _this9.pause();
                                    _this9._executeing = false;
                                    segment.removeEventListener(BEFORE_FINISH, _this9._executeForTargetSegmentBeforreFinishCallback);
                                    _this9._executeForTargetSegmentBeforreFinishCallback = undefined;
                                };
                                segment.addEventListener(BEFORE_FINISH, _this9._executeForTargetSegmentBeforreFinishCallback);
                            } else {
                                _this9._executeing = false;
                            }

                            if (arrange) {
                                _this9.start(arrange, segment);
                            } else {
                                _this9.start(segment);
                            }

                            _this9.removeEventListener(FINISH, _this9._executeForPrevFinishCallback);
                            _this9._executeForPrevFinishCallback = undefined;
                        };
                        this.addEventListener(FINISH, this._executeForPrevFinishCallback);
                    ...
                    value: function _switch() {
                        ...
                        this._switchForPrevFinishCallback = function () {
                            ...
                            if (isPaused) {
                                if (_this10.hasEventListener(START, _this10._switchForStartAfterCallback)) {
                                    _this10.removeEventListener(START, _this10._switchForStartAfterCallback);
                                }
                                _this10._switchForStartAfterCallback = function () {
                                    _this10.pause();
                                    _this10._switching = false;
                                    _this10.removeEventListener(START, _this10._switchForStartAfterCallback);
                                    _this10._switchForStartAfterCallback = undefined;
                                };
                                _this10.addEventListener(START, _this10._switchForStartAfterCallback);
                            } else {
                                _this10._switching = false;
                            }
                            if (arrange) {
                                _this10.start(arrange, segment);
                            } else {
                                _this10.start(segment);
                            }
                            _this10.removeEventListener(FINISH, _this10._switchForPrevFinishCallback);
                            _this10._switchForPrevFinishCallback = undefined;
                        };
                        this.addEventListener(FINISH, this._switchForPrevFinishCallback);
                    ...
                    value: function dispose() {
                        ...
                        if (!this._disposeFinishCallback) {
                            //销毁前先停止事件
                            this._disposeFinishCallback = function () {
                                var arrangementsLength = _this11._arrangements.length;
                                for (var i = 0; i < arrangementsLength; i++) {
                                    _this11._arrangements[i].dispose();
                                }
                                _this11._currentArrange = undefined;
                                _this11._arrangements = [];
                                _this11._segments = [];
                                _this11.disposeEvent();
                            };
                        }
                        if (this._isPlaying) {
            ...
            function arrangeEventBind(arrange) {
                ...
                arrange.addEventListener(START, function () {
                    if (!_this12._isPlaying) return;
                    _this12._currentArrange = arrange;
                });
                arrange.addEventListener(UPDATE, function (_ref) {
                    var currentSegment = _ref.currentSegment;
