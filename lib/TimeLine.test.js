(function (global, factory) {
                ...
                _createClass(TimeLine, [{
                    ...
                    value: function setSegments() {
                        ...
                        this._arrangements.forEach(function (arrangement) {
                            arrangement.setSegments(segments);
                        });
                    ...
                    value: function forceStart() {
                        ...
                        if (this._isPlaying) {
                            ...
                            this._finishForForceStartCallback = function () {
                                _this3.removeEventListener(FINISH, _this3._finishForForceStartCallback);
                                _this3._finishForForceStartCallback = undefined;
                                _this3.start.apply(_this3, target);
                            };
                        ...
                        if (this._currentArrange instanceof Arrange) {
                            ...
                            if (currentArrange !== endArrange) {
                                ...
                                this._currentArrangeFinishForStopCallback = function () {
                                    _this4._currentArrange.removeEventListener(FINISH, _this4._currentArrangeFinishForStopCallback);
                                    _this4._currentArrangeFinishForStopCallback = undefined;
                                    _this4.dispatchEvent({
                                        type: FINISH
                                    });
                                };
                    ...
                    value: function pause() {
                        ...
                        if (this._currentArrange instanceof Arrange) {
                            ...
                            this._currentArrangePauseCallback = function () {
                                _this5._isPaused = true;
                                _this5._currentArrange.removeEventListener(PAUSE, _this5._currentArrangePauseCallback);
                                _this5._currentArrangePauseCallback = undefined;
                                _this5.dispatchEvent({
                                    type: PAUSE
                                });
                            };
                    ...
                    value: function resume() {
                        ...
                        if (this._currentArrange instanceof Arrange) {
                            ...
                            this._currentArrangeResumeCallback = function () {
                                ...
                                _this6._currentArrange.removeEventListener(RESUME, _this6._currentArrangeResumeCallback);
                                _this6._currentArrangeResumeCallback = undefined;
                                _this6.dispatchEvent({
                                    type: RESUME
                                });
                            };
                    ...
                    value: function execute() {
                        ...
                        this._executeForPrevFinishCallback = function () {
                            //如果是暂停的就切换到对应segment后执行完就暂停
                            if (isPaused) {
                                if (segment.hasEventListener(BEFORE_FINISH, _this7._executeForTargetSegmentBeforreFinishCallback)) {
                                    segment.removeEventListener(BEFORE_FINISH, _this7._executeForTargetSegmentBeforreFinishCallback);
                                }
                                _this7._executeForTargetSegmentBeforreFinishCallback = function () {
                                    _this7.pause();
                                    _this7._executeing = false;
                                    segment.removeEventListener(BEFORE_FINISH, _this7._executeForTargetSegmentBeforreFinishCallback);
                                    _this7._executeForTargetSegmentBeforreFinishCallback = undefined;
                                };
                                segment.addEventListener(BEFORE_FINISH, _this7._executeForTargetSegmentBeforreFinishCallback);
                            } else {
                                _this7._executeing = false;
                            }
                            ...
                            _this7.removeEventListener(FINISH, _this7._executeForPrevFinishCallback);
                            _this7._executeForPrevFinishCallback = undefined;
                        };
                        this.addEventListener(FINISH, this._executeForPrevFinishCallback);
                    ...
                    value: function _switch() {
                        ...
                        this._switchForPrevFinishCallback = function () {
                            ...
                            if (isPaused) {
                                if (_this8.hasEventListener(START, _this8._switchForStartAfterCallback)) {
                                    _this8.removeEventListener(START, _this8._switchForStartAfterCallback);
                                }
                                _this8._switchForStartAfterCallback = function () {
                                    _this8.pause();
                                    _this8._switching = false;
                                    _this8.removeEventListener(START, _this8._switchForStartAfterCallback);
                                    _this8._switchForStartAfterCallback = undefined;
                                };
                                _this8.addEventListener(START, _this8._switchForStartAfterCallback);
                            } else {
                                _this8._switching = false;
                            }
                            if (arrange) {
                                _this8.start(arrange, segment);
                            } else {
                                _this8.start(segment);
                            }
                            _this8.removeEventListener(FINISH, _this8._switchForPrevFinishCallback);
                            _this8._switchForPrevFinishCallback = undefined;
                        };
                        this.addEventListener(FINISH, this._switchForPrevFinishCallback);
            ...
            function arrangeEventBind(arrange) {
                ...
                arrange.addEventListener(START, function () {
                    if (!_this9._isPlaying) return;
                    _this9._currentArrange = arrange;
                });
