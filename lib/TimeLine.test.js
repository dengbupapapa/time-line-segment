(function (global, factory) {
            ...
            function createTween(_ref17) {
                ...
                if (type === "interval") {
                    ...
                    tween._onUpdate(function (_ref18) {
                        ...
                        var globalPercent = time / _this7._totalTime;
                        fn.call(_this7, time, percent, globalPercent);
                    });
            ...
            function segmentRun() {
                ...
                var startElements = transactions.map(function (_ref21) {
                    ...
                    return new _Promise(function (resolve) {
                        tween._onStart(function (_ref22) {
                            ...
                            fn.call(_this8, time, 0, time / _this8._totalTime);
                            resolve();
                        });
                    });
                });
                ...
                _Promise.race(startElements).then(function () {
                    _this8.dispatchEvent({ type: START, transactions: transactions });
                });
                ...
                _Promise.all(beforeFinishElements).then(function () {
                    // this._isPlaying = false;
                    _this8.dispatchEvent({ type: BEFORE_FINISH, transactions: transactions });
                    //如果有定义下一个衔接的片段
                ...
                _Promise.all(completeElements).then(function () {
                    // this._isPlaying = false;
                    _this8.dispatchEvent({ type: COMPLETE, transactions: transactions });
                    //如果有定义下一个衔接的片段
                    // if (this._nextSegment instanceof Segment) this._nextSegment.start();
                });
                ...
                _Promise.all(finishElements).then(function () {
                    ...
                    if (typeof _this8._nextSegmentStrat === "function" && result.includes("complete")) {
                        //先开始在结束，防止_currentSegment有间隙无法正常操作
                        if (_this8._nextSegment.hasEventListener(START, _this8._currentSegmentFinish2nextSegmentStartCallback)) {
                            _this8._nextSegment.removeEventListener(START, _this8._currentSegmentFinish2nextSegmentStartCallback);
                        }
                        _this8._currentSegmentFinish2nextSegmentStartCallback = function () {
                            _this8._nextSegment.removeEventListener(START, _this8._currentSegmentFinish2nextSegmentStartCallback);
                            _this8._currentSegmentFinish2nextSegmentStartCallback = null;
                            _this8.dispatchEvent({ type: FINISH, transactions: transactions });
                        };
                        _this8._nextSegment.addEventListener(START, _this8._currentSegmentFinish2nextSegmentStartCallback);
                        _this8._nextSegmentStrat();
                    } else {
                        _this8.dispatchEvent({ type: FINISH, transactions: transactions });
                    }
                });
                ...
                transactions.forEach(function (_ref26) {
                    ...
                    if (!playback) {
                        ...
                        if (type === "interval") {
                            tween.delay(_this8._totalTime - value[1]);
                        } else if (type === "point") {
                            tween.delay(_this8._totalTime - value);
                        }
                    }
            ...
            var Arrange = function (_EventDispatcher) {
                ...
                function Arrange(segments) {
                    ...
                    _this._currentSegmentStartCallback = function (_ref) {
                        ...
                        _this.dispatchEvent({ type: PROGRESS, currentSegment: target });
                    };
            ...
            function arrangeEventBind(arrange) {
                ...
                arrange.addEventListener(PROGRESS, function (_ref) {
