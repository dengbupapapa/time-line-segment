(function (global, factory) {
            ...
            var Segment = function (_EventDispatcher) {
                ...
                function Segment() {
                    ...
                    updatePlaceholderTransactionDuration.call(_this);
                    return _this;
                }
            ...
            function updatePlaceholderTransactionDuration() {
                ...
                var placeholderTransactionFn = function placeholderTransactionFn(time, elapsed, globalPercent, totalTime) {
                    ...
                    time = time > _this7._totalTime ? _this7._totalTime : time;
            ...
            function segmentRun() {
                ...
                if (names.length > 0) {
                    transactions = this._transactions.filter(function (_ref19) {
                ...
                //开始
                var startElements = transactions.map(function (_ref21) {
                    var tween = _ref21.tween,
                        fn = _ref21.fn;

                    return new _Promise(function (resolve) {
                        tween._onStart(function (_ref22) {
                            var time = _ref22.time;
                ...
                //完整的结束之前
                var beforeFinishElements = transactions.map(function (_ref23) {
            ...
            function arrangeEventBind(arrange) {
                ...
                arrange.addEventListener(START, function () {
                    if (!_this11._isPlaying) return;
                    _this11._currentArrange = arrange;
                });
